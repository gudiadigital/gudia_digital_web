...
export function ContactForm({ dict }: { dict: Dictionary }) {
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="card rounded-2xl p-6 sm:p-8">
      ...
      <button
        type="submit"
        className="bg-accent mt-7 w-full rounded-full px-6 py-3.5 text-sm font-semibold text-white shadow-[0_12px_32px_-12px_var(--accent)] transition-transform hover:-translate-y-0.5 sm:w-auto sm:px-8"
      >
        {t.submit}
      </button>
    </form>
