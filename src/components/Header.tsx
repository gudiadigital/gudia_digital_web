      ...
      <Container className="flex h-16 items-center justify-between gap-4 sm:h-18">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            ...
            className="bg-accent hidden rounded-full px-4 py-2 text-sm font-semibold text-white shadow-[0_8px_24px_-10px_var(--accent)] transition-transform hover:-translate-y-0.5 sm:inline-flex"
          >
            {nav.cta}
          </Link>
